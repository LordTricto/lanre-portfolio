...
function Fora(): JSX.Element {
	...
	useGSAP(
		() => {
			...
			tl2.current.from(`.gsap-revised-phone-imgs img`, {
				opacity: "0",
				translateY: "10%",
				...
				<div id="gsap-index-div" className="h-full w-full flex flex-col gap-4">
					...
					<div className="flex flex-col justify-start items-start w-full mb-2 gap-28">
						...
						<ProjectDescription
							...
							quote={
								<>
									Ignoring UI would be like going on a first date without making any effort, still expecting to get that second
									date.”
								</>
							}
