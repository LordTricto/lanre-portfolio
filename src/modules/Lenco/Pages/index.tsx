...
function Lenco(): JSX.Element {
	...
	useGSAP(
		() => {
			...
			gsap.from(`.gsap-assessing-phone-imgs`, {
				scrollTrigger: {
			...
			gsap.from(`.gsap-revised-phone-imgs`, {
				scrollTrigger: {
				...
				<div id="gsap-index-div" className="h-full w-full flex flex-col gap-4">
					...
					<div className="flex flex-col justify-start items-start w-full mb-2 gap-28">
							...
							<div className="gsap-assessing-phone-section flex flex-col justify-start items-start w-full gap-8">
								...
								<div className="gsap-assessing-phone-imgs grid grid-cols-2 2xs:grid-cols-4 mt-4 gap-8 lg:gap-16">
									...
									<img
										...
										src={AssessingImgThree}
										alt="lenco-old-app"
										onLoad={handleUpdateImageCount}
									/>
									<img
										className="w-fit object-contain"
										src={AssessingImgFour}
										alt="lenco-old-app"
										onLoad={handleUpdateImageCount}
									/>
								</div>
						...
						<div className="flex flex-col justify-start items-start w-full gap-16">
							...
							/>
							<div
								className="flex justify-start lg:justify-between items-start flex-col lg:flex-row w-full
							 gap-16 lg:gap-8 px-4 2xs:px-8 lg:px-16 max-w-7xl mx-auto"
							>
								<div className="w-full lg:w-50% xl:w-40%">
									<PhoneContainer
										title="Virtual Cards"
					...
					<div
						className={`gsap-page-departure-transition-div left-right-lenco-gradient h-full w-[150vw] 2xs:w-[220vw] absolute top-0 left-[100%] z-30 `}
					></div>
				</div>
			</main>
		</>
