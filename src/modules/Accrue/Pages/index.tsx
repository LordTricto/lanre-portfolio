...
function Accrue(): JSX.Element {
	...
	useGSAP(
		...
		{dependencies: [numOfImages], scope: mainDivRef}
	);
			...
			>
				<div id="gsap-index-div" className="h-full w-full flex flex-col gap-4">
					...
					<div className="flex flex-col justify-start items-start w-full mb-2 gap-28">
						...
						<ProjectDescription
							title="Accrue"
							subTitle="Accrue Savings is a New York-based fintech startup that helps users save money towards
							 purchases by offering customizable savings plans and cash rewards."
							...
							<div className="flex flex-col justify-start items-start w-full gap-28">
								...
								<div className="flex justify-start lg:justify-between items-start flex-col lg:flex-row w-full gap-16 lg:gap-8">
									<div className="w-full lg:w-50% xl:w-60%">
										<PhoneContainer
											title="Homepage"
											subTitle="Personalization adds a nice touch to the user's perception of the product
											 and is an easy way to strengthen user's experience."
											customTitleStyle="text-accrue-blue-dark"
											customSubtitleStyle="text-black"
									...
									<div className="w-full lg:w-50% xl:w-40%">
										<PhoneContainer
											title="Retail"
											subTitle="Recommendations help users discover most relevant products, enhance
											 experience, and reduce barriers to purchase (allowing users save more)."
								...
								<div className="flex justify-start lg:justify-between items-start flex-col lg:flex-row w-full gap-16 lg:gap-8">
									...
									<div className="w-full lg:w-50% xl:w-60%">
										<PhoneContainer
											title="Savings"
											subTitle="Setting financial goals is essential and help users stay focused on what
											 they are actually saving for. Rewards programs are crucial because they make the user feel uniquely valued."
											customTitleStyle="text-accrue-blue-dark"
